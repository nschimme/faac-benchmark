...
3.  **Run**: `python3 run_benchmark.py <name> <output.json> --gate`
...
*   **[Metric Definitions](docs/metrics.md)**: Understanding MOS, Elementary Stream (ES) Bitrate Accuracy, BD-Rate, Stereo Image Δ, and other metrics.
